(function () {
  ...
  (function initPortalLinkActions() {
    if (!document.body.classList.contains('page-portal')) return;
    ...
    document.querySelectorAll('.portal-link-copy').forEach(function (btn) {
    ...
    document.querySelectorAll('.portal-link-share').forEach(function (btn) {
      btn.addEventListener('click', function () {
