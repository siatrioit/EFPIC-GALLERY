...
function efpic_portal_handle(array $config, string $portalToken, string $method): void
{
    ...
    $body .= '<p class="muted">Atzīmē bildes zemāk, ievadi nosaukumu (piem. «Dekorators») un izveido saiti — saņēmējs redzēs <strong>tikai</strong> tās bildes.</p>';
    ...
    $body .= '<p class="muted portal-pick-hint">Atzīmē bildes ar ☑ pirms izveides.</p></form>';
